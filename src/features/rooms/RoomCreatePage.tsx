    ...
    <div className="create-studio-page">
      ...
      <div className="create-studio-grid">
        <section className="content-panel form-panel" aria-labelledby="basic-info-title">
          <h2 id="basic-info-title">기본 정보 & 후보 구성</h2>
          <form className="stacked-form" onSubmit={handleSubmit}>
            ...
            <div className="candidate-setup-section">
              ...
              <div className="candidate-setup-list">
                {formInput.candidates.map((candidate, index) => (
                  <div key={`${candidate}-${index}`} className="candidate-setup-item">
                    <div className="candidate-setup-item-left">
              ...
              <p className="candidate-setup-desc">
