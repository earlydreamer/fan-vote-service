...
- 상태: in_progress
- 현재 진행 중: 기술 스택/디렉터리 구조 문서화 커밋 장부 반영.
...
| `2328edb` | 기술 스택/디렉터리 구조와 React Best Practice 지침 반영 | `npm test`, `npm run build` | main 직접 커밋은 bootstrap 예외로 문서화 |
| 예정 | 기술 스택/구조 지침 커밋 장부 반영 | `npm test`, `npm run build` | 현재 작업에서 커밋 예정 |
...
- 초기 세팅 커밋은 `bdd2e25`, `5d2bfba`, `0c284ca`, `200f925`, `2328edb`로 의미 단위 분리했다.
