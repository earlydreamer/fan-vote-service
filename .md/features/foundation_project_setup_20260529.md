...
- 상태: in_progress
- 현재 진행 중: 로컬 의미 단위 커밋 완료, push/draft PR은 다음 승인 후 진행.
...
| 예정 | foundation 작업 로그의 실제 커밋 장부 반영 | `npm test`, `npm run build` | 현재 작업에서 커밋 예정 |
...
- 초기 세팅 커밋은 `bdd2e25`, `5d2bfba`, `0c284ca`로 의미 단위 분리했다.
